...
<head>
    ...
    <title>Dashboard - Pasar Coffee 🍵</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="index.php">Pasar Coffee 🍵</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="apriori.php">Analisis Apriori</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <!-- Analisis Apriori Card -->
            <div class="col-md-3 mb-4">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <?php
                        $stmt = $pdo->query("SELECT COUNT(*) FROM apriori_rules");
                        $total_rules = $stmt->fetchColumn();
                        ?>
                        <h5 class="card-title">Pola Pembelian</h5>
                        <h2><?php echo $total_rules; ?> Pola</h2>
                        <a href="apriori.php" class="btn btn-light btn-sm mt-2">Lihat Analisis</a>
                    </div>
                </div>
            </div>
        </div>
